...
public class CalculateLight : MonoBehaviour
{
	...
	public void BakeSSAO()
    {
        GameObject subject = this.gameObject;
            ...
            for (i = 0; i < l; i++)
            {
                ...
                for (j = 0; j < samples; j++)
                {
                    ...
                    if (debugSample)
                    {
                        ...
                        if (isHit)
                            sphere = (GameObject)GameObject.Instantiate(psphere_hit);
                        else
                            sphere = (GameObject)GameObject.Instantiate(psphere_miss);
                        ...
                        sphere = (GameObject)GameObject.Instantiate(psphere);
                        sphere.name += "_" + sample;
                        sp = offset;
